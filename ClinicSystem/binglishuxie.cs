...
namespace ClinicSystem
{
    public partial class binglishuxie : Form
    {
        ...
        {
            string sql = "insert into bingli(zhushu, jiwangshi, jiazushi, jianchaqingkuang, zhenliaojihua) values('" + rb_zhushu.Text + "', '" + rb_jiwangshi.Text + "', '" + rb_jiazushi.Text + "', '" + rb_jianchaqingkuang.Text + "', '" + rb_zhenliaojihua.Text + "')";
            Base.sql_insert(sql);
        }
